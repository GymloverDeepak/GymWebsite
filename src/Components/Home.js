            ...
            <div className="row px-3">
              <div className="col-md-6 p-0">
                <div className="gym-className-box d-flex flex-column align-items-end justify-content-center bg-primary text-right text-white py-5 px-5">
                  ...
                  <p>
                    ...
                    to control and develop one's muscles by muscle hypertrophy
                    for aesthetic purposes. It is distinct from similar
                    activities such as powerlifting because it focuses on
                    physical appearance instead of strength
                  </p>
              ...
              <div className="col-md-6 p-0">
                <div className="gym-className-box d-flex flex-column align-items-start justify-content-center bg-secondary text-left text-white py-5 px-5">
                  ...
                  <p>
                    What does it mean to build muscle? Muscle size increases
                    when a person continually challenges the muscles to deal
                    with higher levels of resistance or weight. This process is
                    known as muscle hypertrophy. Muscle hypertrophy occurs when
                    the fibers of the muscles sustain damage or injury.
                  </p>
                  <a href="" className="btn btn-lg btn-outline-light mt-4 px-4">
                    Start Now
                  </a>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-sm-7">
                    ...
                    <p>
                      ...
                      clear on the best use of your time, you become more
                      focused and productive. Good time management helps you
                      achieve bigger goals, reduces procrastination, and
          ...
          <div className="container gym-feature py-5">
            ...
            <div className="tab-className">
              ...
              <div className="tab-content">
                <div
                  id="className-all"
                  className="container tab-pane p-0 active"
                >
            ...
            <div className="row">
              <div className="col-lg-6 mb-5 blog-item">
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  >
                    <small>01</small>
                    <strong className="text-uppercase m-0 text-white">
                      Jan
                    </strong>
                    <small>2023</small>
                  </div>
                ...
                manage some health conditions. For example: Calcium and vitamin
                D help keep bones strong and reduce bone loss. Folic acid
